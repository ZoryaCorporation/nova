...
exports.IconCustomizerPanel = void 0;
...
/*  Webview Panel                                                      */
/* ------------------------------------------------------------------ */
class IconCustomizerPanel {
    static viewType = 'novaIconCustomizer';
    static _instance;
    _panel;
    _extensionUri;
    _disposables = [];
    static show(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel(IconCustomizerPanel.viewType, 'Custom File Icons', vscode.ViewColumn.One, { enableScripts: true, retainContextWhenHidden: true });
    ...
    _removeMapping(ext) {
        ...
        if (theme.fileExtensions) {
            delete theme.fileExtensions[sanitizedExt];
        }
        if (theme.light?.fileExtensions) {
            delete theme.light.fileExtensions[sanitizedExt];
        }
        this._writeTheme(theme);
        /* Remove SVG file */
...
exports.IconCustomizerPanel = IconCustomizerPanel;
//# sourceMappingURL=iconCustomizer.js.map